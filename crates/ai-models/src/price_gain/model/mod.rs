...
use crate::price_gain::data::batcher::{PriceGainInferenceBatch, PriceGainTrainingBatch};
use burn::{
    nn::{
...
impl InferenceStep for PriceGainModel {
    type Input = PriceGainTrainingBatch;        // TODO - PMB shouldn't this be PriceGainInferenceBatch??
    type Output = ClassificationOutput;
